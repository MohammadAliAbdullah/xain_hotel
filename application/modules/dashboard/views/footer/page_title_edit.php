...
<div class="form-group row">
    <label for="roomdetails" class="col-sm-3"><?php echo display("room_details") ?> <i class="text-danger"> *</i></label>
    <div class="col-sm-9">
        <input name="roomdetails" type="text" class="form-control" id="roomdetails" placeholder="<?php echo display("room_details") ?>" value="<?php echo html_escape($teammember_edit->roomdetails); ?>" required>
    </div>
</div>
<div class="form-group row">
