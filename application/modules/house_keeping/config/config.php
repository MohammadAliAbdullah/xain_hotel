...
$HmvcConfig['house_keeping']["_description"] = "House keeping module provides room service, laundry service and it also has house keeping android ap for managing room cleanig with QR code ";
$HmvcConfig['house_keeping']["_price"]   = 29;
