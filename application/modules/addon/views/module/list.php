        ...
        <div class="card panel-bd">
            <div class="card-header">
                <div class="panel-title box-header">
                    ...
                    <h6 style="color: red;margin-right: auto; margin-left: 10px;"><i>Addons are not included at envato purchase</i></h6>
                    <div>
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h3><?php echo html_escape(($HmvcConfig[$mod]['_title']!=null)?$HmvcConfig[$mod]['_title']:null) ?>
                                    <span class="float-right text-danger font-weight"><?php echo '$'.html_escape(($HmvcConfig[$mod]['_price']!=null)?$HmvcConfig[$mod]['_price'].".00":null) ?></span>
                                </h3>
