        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="cancelreason" class="col-sm-4 col-form-label"><?php echo display("cancel_reason"); ?> <span
                            class="text-danger">*</span></label>
                    <input class="col-sm-8" required name="cancelreason" type="text" placeholder="<?php echo display("cancel_reason") ?>"
                        value="">
                </div>
                <div class="form-group row">
